      ...
      <div class="chatbot-window" id="chatbot-window" aria-hidden="true">
        <div class="chatbot-header">
          <div>
            ...
            <div class="chatbot-subtitle">${escapeHtml(s.name || 'Scheda corrente')}</div>
          </div>
        ...
        <div class="chatbot-messages" id="chatbot-messages">
          <div class="chatbot-message bot">
            ...
            <div>Chiedimi informazioni sulla sintesi corrente: sequenza, PM, cleavage, ciclizzazione, attivatori, inventario, MS o HPLC.</div>
          </div>
        </div>
...
function bindSynthesisChatbotEvents(synthesis) {
  ...
  function ask(question) {
    ...
    addChatbotMessage('bot', answerSynthesisQuestion(synthesis, question));
    input.value = '';
  }
...
function answerSynthesisQuestion(s, question) {
  ...
  if (!q || /(aiuto|help|cosa puoi|domande|comandi)/.test(q)) {
    return 'Posso rispondere sui dati della scheda corrente: sequenza, numero residui, resina, loading, scala, massa resina, PM peptide, addotti MS, cleavage, ciclizzazione, attivatori, inventario, Wang preloaded, HPLC e note.';
  }
  ...
  return 'Non sono sicuro di aver capito. Posso aiutarti con sequenza, PM, resina, cleavage, ciclizzazione, attivatori, inventario, MS, HPLC, note e tips letteratura.';
}
