...
function renderHeader() {
  return `
    <header class="app-header-centered">
      <button type="button" class="app-brand app-brand-home" id="btn-home-logo" aria-label="Torna alla home principale">
...
function bindHeaderEvents() {
  const homeLogo = document.getElementById('btn-home-logo');
  if (homeLogo) homeLogo.addEventListener('click', () => navigate('dashboard'));
}
