...
function renderCyclizationProtocolCalculations(cycle, synthesis) {
  ...
  return `
    <div class="cyclization-calculations">
      ...
      <div class="cyclization-calculations-table">
        <div class="cyclization-calculations-row cyclization-calculations-head">
          <span>Fase</span><span>Reagente</span><span>Eq</span><span>PM</span><span>Da pesare</span>
        </div>
        ${rows.map(function(row) {
          return '<div class="cyclization-calculations-row"><span>' + escapeHtml(row.phase) + '</span><span>' + escapeHtml(row.reagent) + '</span><span class="mono">' + escapeHtml(row.eq) + '</span><span class="mono">' + escapeHtml(row.mw) + '</span><span class="mono">' + escapeHtml(row.amount) + '</span></div>';
        }).join('')}
      </div>
